...
func templatesGoDockerfile() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/go/Dockerfile", size: 1411, mode: os.FileMode(0644), modTime: time.Unix(1710302540, 0)}
...
func templatesGoFunctionDummyGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/go/function/dummy.go", size: 223, mode: os.FileMode(0644), modTime: time.Unix(1710302540, 0)}
...
func templatesGoFunctionHandlerGoTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/go/function/handler.go.tmpl", size: 177, mode: os.FileMode(0644), modTime: time.Unix(1710302540, 0)}
...
func templatesGoGoMod() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/go/go.mod", size: 320, mode: os.FileMode(0644), modTime: time.Unix(1710302540, 0)}
